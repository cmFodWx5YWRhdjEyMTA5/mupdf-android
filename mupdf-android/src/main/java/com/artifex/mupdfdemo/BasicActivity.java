...
public class BasicActivity extends Activity implements FilePicker.FilePickerSupport
{
    ...
    private RelativeLayout mInkConfirm;
    private TextView mTvPencilok;
    private LinearLayout mFunctionButtons;
    private LinearLayout mFunctionsDraw;
            ...
            mOutlineButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (outline != null) {
                        ...
                        Intent intent = new Intent(BasicActivity.this, OutlineActivity.class);
...
//        mLinkButton.setColorFilter(highlight ? Color.argb(0xFF, 172, 114, 37) : Color.argb(0xFF, 255, 255, 255));
    ...
    private void makeButtonsView() {
        mButtonsView = getLayoutInflater().inflate(R.layout.basicbuttons,null);
...
//        mReflowButton = (ImageButton)mButtonsView.findViewById(R.id.reflowButton);
        mOutlineButton = (ImageButton)mButtonsView.findViewById(R.id.outlinebottommenu);
...
//        mAnnotTypeText = (TextView)mButtonsView.findViewById(R.id.annotType);
        ...
        mInkConfirm = (RelativeLayout)mButtonsView.findViewById(R.id.inkConfirm);
        mTvPencilok = (TextView)mButtonsView.findViewById(R.id.tv_pencilok);
        mFunctionButtons = (LinearLayout)mButtonsView.findViewById(R.id.functionButtons);
        mFunctionsDraw = (LinearLayout)mButtonsView.findViewById(R.id.functionsDraw);
...
//        mMoreButton = (ImageButton)mButtonsView.findViewById(R.id.moreButton);
        ...
        mInfoView.setVisibility(View.INVISIBLE);
        mLowerButtons.setVisibility(View.INVISIBLE);
        mInkConfirm.setVisibility(View.INVISIBLE);
        mFunctionsDraw.setVisibility(View.INVISIBLE);
    }
...
//        mAnnotTypeText.setText(R.string.strike_out);
    ...
    public void OnInkButtonClick(View v) {
        ...
        mFunctionButtons.setVisibility(View.INVISIBLE);
        mInkConfirm.setVisibility(View.VISIBLE);
    }

    //是否生成签名内容-确认按钮
    public void OnInkButtonOkClick(View v) {
    ...
    //是否生成签名内容-取消按钮
    public void OnInkButtonCancelClick(View v) {
    ...
    //上一章
    public void onLastPageClick(View v){
    ...
    //多功能画笔
    public void OnFunctionsButtonClick(View v){
        mFunctionsDraw.setVisibility(View.VISIBLE);
    }
